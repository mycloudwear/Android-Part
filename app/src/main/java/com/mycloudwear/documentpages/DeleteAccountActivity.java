 ...
 * @version 1.0.1
 * @since 14/5/2019
 * This class could directly link to the document about how to delete an account.
 */
public class DeleteAccountActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView fresh = findViewById(R.id.delete_account);
        ...
        if(language.equals("简体中文"))fresh.loadUrl("https://www.mycloudwear.com/WebLogin/docs/Delete-Account-Guide-ZH.html");
        else fresh.loadUrl("https://www.mycloudwear.com/WebLogin/docs/Delete-Account-Guide-EN.html");
    }
}
