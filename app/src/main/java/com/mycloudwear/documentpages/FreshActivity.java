 ...
 * @version 1.0.1
 * @since 14/5/2019
 * This class could directly link to the document about what's new.
 */
public class FreshActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView fresh = findViewById(R.id.fresh);
        ...
        if(language.equals("简体中文"))fresh.loadUrl("https://www.mycloudwear.com/WebLogin/docs/What-is-New-ZH.html");
        else fresh.loadUrl("https://www.mycloudwear.com/WebLogin/docs/What-is-New-EN.html");
    }
}
