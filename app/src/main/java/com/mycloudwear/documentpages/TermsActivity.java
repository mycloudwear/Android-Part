...
public class TermsActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView terms = findViewById(R.id.terms_service);
        ...
        if(language.equals("简体中文"))terms.loadUrl("https://www.mycloudwear.com/WebLogin/docs/Terms-Of-Service-ZH.html");
        else terms.loadUrl("https://www.mycloudwear.com/WebLogin/docs/Terms-Of-Service-EN.html");
    }
}
